...
$con = mysqli_connect("localhost","graduanm_jisly","3jYZ78BFx0hg;]","graduanm_jisly");
...
function getPro(){
	...
	$get_pro = "select * from products order by RAND() LIMIT 0,30";
				...
				<div class='col-md-4 col-sm-6'>
						<div class='product'>
						 ...
						 <div class='flip-container'>
												...
												<img src='admin_area/product_images/$pro_image' width='210' height='300' />
					...
					<p class='buttons'>
                                        <a href='detail2.php?pro_id=$pro_id' class='btn btn-default'>View detail</a>
				...
				<div class='col-md-4 col-sm-6'>
						<div class='product'>
						 ...
						 <div class='flip-container'>
												...
												<img src='admin_area/product_images/$pro_image' width='253' height='400' />
